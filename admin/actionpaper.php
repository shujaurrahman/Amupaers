...
<script>
    ...
    function getActionIcon(status, paperId) {
        switch(status) {
            case 'pending':
                return `<td><span class='ion-icon-container' onclick='updateStatus("${paperId}", "approved")'><ion-icon name='checkmark-circle' size='large' ></ion-icon></span><span class='ion-icon-container' onclick='updateStatus("${paperId}", "rejected")'><ion-icon name='close' size='large'></ion-icon></span></td>`;
            case 'approved':
                return `<td><span class='ion-icon-container'><ion-icon name='create' size='large'></ion-icon></span><span class='ion-icon-container'><ion-icon name='trash' size='large' onclick='updateStatus("${paperId}", "rejected")'></ion-icon></span></td>`;
            case 'rejected':
                return `<td><span class='ion-icon-container'><ion-icon name='trash' size='large'></ion-icon></span></td>`;
            default:
                return '';
        }
    }
