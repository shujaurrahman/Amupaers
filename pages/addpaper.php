        ...
        <div id="login">
            <div id="formLogin">
                ...
                <form action="#" method="POST" enctype="multipart/form-data" autocomplete="off">
                    ...
                    <div class="inputContainer">
                        <input type="file" class="inputLogin" name="pdfFile" accept=".pdf">
                        <label class="labelLogin">Upload PDF</label>
                    </div>
                    <div class="field button">
                        <input type="submit" class="submitButton" value="Upload Paper">
                    </div>
                </form>
            </div>
        </div>
